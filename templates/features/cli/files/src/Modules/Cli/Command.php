...
final class Command {
	 ...
	 * ## EXAMPLES
	 *
	 *     wp sobol-safe-save info
	 *     wp sobol-safe-save info --format=json
	 *
	 ...
	 * ## EXAMPLES
	 *
	 *     wp sobol-safe-save seed --count=20
	 *
	 * @param array<int, string>    $args       Positional arguments.
	 * @param array<string, string> $assoc_args Named arguments.
	 */
