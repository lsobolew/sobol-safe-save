...
namespace Sobolewski\SobolSafeSave\Modules\ContentType;
...
/**
 * Registers the "sobol_safe_save_item" post type, its taxonomy and a REST-visible meta field.
 */
final class Module implements ModuleContract, ActivationAware {
	 ...
	 */
	const POST_TYPE = 'sobol_safe_save_item';

	/**
	 * Taxonomy name.
	 */
	const TAXONOMY = 'sobol_safe_save_item_type';

	/**
	 * Meta key. The leading underscore hides it from the custom fields box.
	 */
	const META_PRIORITY = '_sobol_safe_save_priority';
	...
	public function register_post_type(): void {
		register_post_type(
			...
			array(
				'labels'       => array(
					'name'          => __( 'Items', 'sobol-safe-save' ),
					'singular_name' => __( 'Item', 'sobol-safe-save' ),
					'add_new_item'  => __( 'Add item', 'sobol-safe-save' ),
					'edit_item'     => __( 'Edit item', 'sobol-safe-save' ),
					'search_items'  => __( 'Search items', 'sobol-safe-save' ),
					'not_found'     => __( 'No items found.', 'sobol-safe-save' ),
				),
				'public'       => true,
				'has_archive'  => true,
	...
	public function register_taxonomy(): void {
		register_taxonomy(
			...
			array(
				'labels'            => array(
					'name'          => __( 'Item types', 'sobol-safe-save' ),
					'singular_name' => __( 'Item type', 'sobol-safe-save' ),
				),
				'public'            => true,
				'hierarchical'      => true,
	...
	public function register_meta(): void {
		register_post_meta(
			...
			array(
				'type'              => 'integer',
				'description'       => __( 'Item priority used when ordering lists.', 'sobol-safe-save' ),
				'single'            => true,
				'default'           => 0,
				'show_in_rest'      => true,
